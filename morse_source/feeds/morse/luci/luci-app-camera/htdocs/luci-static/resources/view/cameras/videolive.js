...
class VideoLiveElement extends HTMLElement {
	...
	static observedAttributes = ["caption", "autoplay", "src", "bitrate", "bitrate-min", "bitrate-max", "brightness", "framerate", "framerate-min", "framerate-max", "resolution", "resolution-options"];
...
return baseclass.extend({
	async loadTemplate() {
		const response = await request.get(L.resource('view/cameras/custom-elements/video-live.html'), {cache: true});
