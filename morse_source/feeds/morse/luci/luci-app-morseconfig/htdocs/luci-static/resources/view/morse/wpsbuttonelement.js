    ...
    updateActiveButton() {
        ...
        switch (this.wpsStatus.pbc_status) {
            ...
            case 'Overlap': // TODO: What is this?
                ...
                this.title = _('Push the WPS button on two EasyMesh devices to connect them.');
                break;
            case 'Unknown':
            default:
                this.buttonElement.disabled = true;
...
// and in prplOS 2.2, but something to do with our setup means that we don't
// see these things in ubus.
